...
public class ActivitySplash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageMuseo = findViewById(R.id.image_museo);
    ...
    private void startEnterAnimation() {
        imageMuseo.startAnimation(AnimationUtils.loadAnimation(this,R.anim.image_in));
        ...
        imageMuseo.setVisibility(View.VISIBLE);
    ...
    private void startExitAnimation() {
        imageMuseo.startAnimation(AnimationUtils.loadAnimation(this,R.anim.image_out));
        ...
        imageMuseo.setVisibility(View.INVISIBLE);
